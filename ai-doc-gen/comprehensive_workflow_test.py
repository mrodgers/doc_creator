...
from src.ai_doc_gen.input_processing.document_parser import PDFParser, HTMLParser, DOCXParser, ParsedDocument
...
def main():
    ...
    print(f"   Review the results to validate your pre-testing works in the end product")
