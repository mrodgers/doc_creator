...
def compare_with_original_scraper(enhanced_parsed_doc):
    ...
    print(f"   Enhanced parser unique features:")
    ...
    print(f"     - Better structure detection: Yes")
    print(f"     - Pandas integration: Yes")
...
def test_web_ui_compatibility(parsed_doc):
    ...
    try:
        ...
        print(f"✅ Enhanced parser results can be serialized for web UI")
        print(f"   - Serialized size: {len(serialized)} characters")
        
        # Test that it can be deserialized
        import json
        deserialized = json.loads(serialized)
        print(f"✅ Enhanced parser results can be deserialized")
